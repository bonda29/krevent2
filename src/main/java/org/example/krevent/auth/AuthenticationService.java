package org.example.krevent.auth;

import com.fasterxml.jackson.databind.ObjectMapper;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import lombok.RequiredArgsConstructor;
import org.example.krevent.models.Token;
import org.example.krevent.models.User;
import org.example.krevent.models.enums.TokenType;
import org.example.krevent.payload.request.AuthenticationRequest;
import org.example.krevent.payload.request.RegisterRequest;
import org.example.krevent.payload.response.AuthenticationResponse;
import org.example.krevent.repository.TokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        try {
            ...
            throw new BadCredentialsException("Invalid email or password"); //todo: change to custom exception or handle it in a different way
        }
